...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "KelpyCrabRoll" item. 
    ...
    [LocDescription("Pieces of crab on a bed of rice rolled up and covered in kelp.")] //The tooltip description for the food item.
    public partial class KelpyCrabRollItem : FoodItem
    {
        ...
        public override Nutrients Nutrition             => new Nutrients() { Carbs = 22, Fat = 11, Protein = 13, Vitamins = 5};
    ...
    /// <summary>
    /// <para>Server side recipe definition for "KelpyCrabRoll".</para>
    ...
    [Ecopedia("Food", "Cooking", subPageName: "Kelpy Crab Roll Item")]
    public partial class KelpyCrabRollRecipe : RecipeFamily
    {
        public KelpyCrabRollRecipe()
        {
            ...
            recipe.Init(
                name: "KelpyCrabRoll",  //noloc
                displayName: Localizer.DoStr("Kelpy Crab Roll"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(KelpyCrabRollRecipe), start: 4, skillType: typeof(AdvancedCookingSkill), typeof(AdvancedCookingFocusedSpeedTalent), typeof(AdvancedCookingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Kelpy Crab Roll"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Kelpy Crab Roll"), recipeType: typeof(KelpyCrabRollRecipe));
