...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "SearedMeat" item. 
    ...
    [LocDisplayName("Seared Meat")] // Defines the localized name of the item.
    [Weight(500)] // Defines how heavy the SearedMeat is.
    [Ecopedia("Food", "Cooking", createAsSubPage: true)]
    [LocDescription("A cut of perfectly seared steak.")] //The tooltip description for the food item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "SearedMeat".</para>
    ...
    [Ecopedia("Food", "Cooking", subPageName: "Seared Meat Item")]
    public partial class SearedMeatRecipe : RecipeFamily
    {
        public SearedMeatRecipe()
        {
            ...
            recipe.Init(
                name: "SearedMeat",  //noloc
                displayName: Localizer.DoStr("Seared Meat"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(SearedMeatRecipe), start: 3, skillType: typeof(AdvancedCookingSkill), typeof(AdvancedCookingFocusedSpeedTalent), typeof(AdvancedCookingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Seared Meat"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Seared Meat"), recipeType: typeof(SearedMeatRecipe));
