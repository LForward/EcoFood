...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "Pirozhok" item. 
    ...
    [LocDisplayName("Pirozhok")] // Defines the localized name of the item.
    [Weight(400)] // Defines how heavy the Pirozhok is.
    [Ecopedia("Food", "Baking", createAsSubPage: true)]
    [LocDescription("A baked bun filled with tasty meat and mushrooms.")] //The tooltip description for the food item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "Pirozhok".</para>
    ...
    [Ecopedia("Food", "Baking", subPageName: "Pirozhok Item")]
    public partial class PirozhokRecipe : RecipeFamily
    {
        public PirozhokRecipe()
        {
            ...
            recipe.Init(
                name: "Pirozhok",  //noloc
                displayName: Localizer.DoStr("Pirozhok"),
                ...
                ingredients: new List<IngredientElement>
                {
                    ...
                    new IngredientElement("Fungus", 4, typeof(AdvancedBakingSkill), typeof(AdvancedBakingLavishResourcesTalent)), //noloc
                },
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(PirozhokRecipe), start: 3, skillType: typeof(AdvancedBakingSkill), typeof(AdvancedBakingFocusedSpeedTalent), typeof(AdvancedBakingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Pirozhok"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Pirozhok"), recipeType: typeof(PirozhokRecipe));
